...
if __name__ == '__main__':
    ...
    cell_populations = {
        ...
        "dp1": ["SOX2", "PAX3", "MSX1", "MSX2", "OLIG3", "IRX3", "IRX5", "PAX6"],
        "dp2": ["SOX2", "PAX3", "MSX1", "OLIG3", "IRX3", "IRX5", "PAX6"],
        "dp3": ["SOX2", "PAX3", "PAX6", "PAX7", "MSX1", "OLIG3", "IRX3", "IRX5", "GSX2", "ASCL1", "GBX2"],
        "dp4": ["SOX2", "PAX3", "PAX6", "PAX7", "IRX3", "IRX5", "GSX1", "GSX2", "ASCL1", "GBX2"],
        "dp5": ["SOX2", "PAX3", "PAX6", "PAX7", "IRX3", "IRX5", "GSX1", "GSX2", "DBX2"],
        "dp6": ["SOX2", "PAX3", "PAX6", "PAX7", "DBX1", "DBX2", "IRX3", "IRX5", "SP8"],
        "p0": ["SOX2", "DBX1", "DBX2", "IRX3", "IRX5", "PAX6", "SP8"],
        "p1": ["SOX2", "NKX6-2", "DBX2", "PRDM12", "IRX3", "IRX5", "PAX6", "SP8"],
        "p2": ["SOX2", "NKX6-1", "IRX3", "IRX5", "FOXN4", "PAX6", "SP8"],
        "pMN": ["SOX2", "NKX6-1", "OLIG2", "SP8"],
        "p3": ["SOX2", "NKX2-2", "NKX2-8", "NKX6-1"],
        "FP": ["SOX2", "FOXA2", "FERD3L", "ARX", "SHH", "LMX1B", "NKX6-1"],

        # === Dorsal interneurons (dl1–dl6) ===
        "dl1": ["STMN2", "MAP2", "ELAVL3", "POU4F1", "LHX2", "LHX9", "BARHL1", "BARHL2", "ATOH1"],
        "dl2": ["STMN2", "MAP2", "ELAVL3", "POU4F1", "FOXD3", "LHX1", "LHX5"],
        "dl3": ["STMN2", "MAP2", "ELAVL3", "POU4F1", "ISL1", "TLX3", "OTP"],
        "dl4": ["STMN2", "MAP2", "ELAVL3", "LBX1", "LHX1", "LHX5", "PAX2", "PAX8", "GBX1", "BHLHE22", "PAX3", "PAX7", "PTF1A", "GSX1", "GSX2"],
        "dl5": ["STMN2", "MAP2", "ELAVL3", "LBX1", "LMX1B", "POU4F1", "TLX3", "PAX3", "PAX7", "ASCL1", "GSX1", "GSX2"],
        "dl6": ["STMN2", "MAP2", "ELAVL3", "LBX1", "LHX1", "LHX5", "PAX2", "DMRT3", "WT1", "BHLHE22"],

        # === Ventral interneurons (V0–V3) ===
        "V0": ["STMN2", "MAP2", "ELAVL3", "EVX1", "EVX2", "LHX1", "LHX5", "PITX2"],
        "V1": ["STMN2", "MAP2", "ELAVL3", "EN1", "FOXD3", "LHX1", "LHX5", "BHLHE22", "PAX2", "OTP"],
        "V2a": ["STMN2", "MAP2", "ELAVL3", "LHX3", "VSX2", "SOX14", "SOX21", "BHLHE22", "FOXN4", "VSX1", "ASCL1"],
        "V2b": ["STMN2", "MAP2", "ELAVL3", "TAL1", "GATA2", "GATA3", "BHLHE22", "LHX1", "LHX5", "MSX1", "FOXN4", "VSX1", "ASCL1"],
        "V3": ["STMN2", "MAP2", "ELAVL3", "NKX2-2", "SIM1"],

        # === Motor neurons ===
        "MN": ["STMN2", "MAP2", "ELAVL3", "LHX3", "ISL1", "ISL2", "MNX1", "OLIG2", "SLC10A4", "SLC18A3", "ALDH1A2", "ARHGAP36"],

        # === Peripheral nervous system ===
        "BCC": ['PRSS56', 'EGR2', 'WIF1', 'HEY2'],
        "Unspecialised_sensory_neuron": ["STMN2", "MAP2", "ELAVL3", "SIX1", "POU4F2", "POU4F3"],
        "LTMR_I": ["STMN2", "MAP2", "ELAVL3", "SIX1", "NTRK2", "CACNA1H"],
        "LTMR_II": ["STMN2", "MAP2", "ELAVL3", "SIX1", "NEFH", "RET"],
        "Myelinated_LTMR": ["STMN2", "MAP2", "ELAVL3", "SIX1", "NEFH", "RET", "FAM19A1"],
        "Proprioceptor": ["STMN2", "MAP2", "ELAVL3", "SIX1", "NTRK3", "RUNX3", "PARVB"],
        "Nonpeptidergic_nociceptor": ["STMN2", "MAP2", "ELAVL3", "SIX1", "PLXNC1", "P2RX3", "SCN10A", "TRPV1"],
        "Peptidergic_nociceptor": ["STMN2", "MAP2", "ELAVL3", "SIX1", "NTRK1", "SCN10A", "TRPV1"],
        "C_LTMR": ["STMN2", "MAP2", "ELAVL3", "SIX1", "PIEZO2", "TH", "GFRA2", "SLC17A8"],
